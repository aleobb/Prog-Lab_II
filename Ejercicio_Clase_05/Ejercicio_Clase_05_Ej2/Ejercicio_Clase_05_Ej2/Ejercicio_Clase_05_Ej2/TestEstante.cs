...
{
    //Llamar de un constructor a otro:
    // public MiClase(int cant): this(cant, [string] nombre);
    // en ese constructor lo primero que se ejecuta es el this y recién después el código del constructor que lo llamó
